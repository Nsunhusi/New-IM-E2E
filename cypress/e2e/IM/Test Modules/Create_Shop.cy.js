...
describe('InsideMarket New user flow', () => {
    before(function(){
    ...
    it('Create a shop', () => {
        ...
        cy.get(':nth-child(1) > .hidden > :nth-child(1) > :nth-child(2) > [style="position: relative;"] > .shadow-none').type("sdfghjklkjhggguyguygguygug")
        // cy.get(':nth-child(1) > .hidden > :nth-child(1) > :nth-child(2) > :nth-child(3) > .shadow-none > .grid > .col-span-11 > .MuiInputBase-root > #phone').type("08077776512")
        cy.wait(4000)
        cy.get(':nth-child(1) > .hidden > :nth-child(1) > [style="padding-top: 88px;"] > .justify-center > .col-span-7 > .gap-4 > :nth-child(1) > :nth-child(1) > [style="border-radius: 7px; border: 1px solid rgb(230, 230, 230); width: 100%; height: auto; padding: 12px 11px;"] > [style="display: flex; align-items: center; width: 100%;"] > div > select').select(2)
        // cy.wait(5000)
        ...
        cy.get(':nth-child(1) > .hidden > :nth-child(1) > [style="padding-top: 88px;"] > .justify-center > .col-span-7 > .gap-4 > .col-span-12 > :nth-child(1) > .bg-white').type('Ikeja,Nigeria').type("{enter}")
        // cy.wait(5000)
        ...
        cy.get(':nth-child(1) > .hidden > :nth-child(1) > [style="padding-top: 50px;"] > .container > .col-span-7 > :nth-child(2) > .shadow-none > .grid > .col-span-11 > .MuiInputBase-root > #whatsapp').type('09099998764')
        // cy.wait(5000)
